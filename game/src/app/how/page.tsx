export const metadata = { title: "How it works — Spreadcast" };
  ...
  return (
    <>
      ...
      <div className="panel" style={{ marginTop: 16 }}>
        <h2 style={{ color: "var(--volt)", fontSize: 14 }}>THE FINE PRINT</h2>
        <p className="notice">
