...
export const LISTINGS: MarketListing[] = [
  { id: "lst-1", vaultId: "bess-graz-01", seller: "0x7A23f9C1e4B8d0a5F6c2E91b3D4a8C7e1F0b9D22", shares: 150000, pricePerShare: 1.085, listedAtDaysAgo: 12, estApyBps: 0 },
  { id: "lst-2", vaultId: "bess-koper-01", seller: "0x3F8b1D6e2A9c4f7B0E5a8C1d2F3e4A5b6C7d8E90", shares: 50000, pricePerShare: 1.12, listedAtDaysAgo: 3, estApyBps: 0 },
  ...
  { id: "lst-4", vaultId: "bess-graz-01", seller: "0x1D4a7B0e3C6f9A2b5E8d1C4f7A0b3E6d9C2f5A88", shares: 80000, pricePerShare: 1.04, listedAtDaysAgo: 1, estApyBps: 0 },
  { id: "lst-5", vaultId: "bess-koper-01", seller: "0x5E8b2C5f8A1d4B7e0C3a6F9b2D5e8A1c4F7b0D33", shares: 120000, pricePerShare: 1.095, listedAtDaysAgo: 20, estApyBps: 0 },
